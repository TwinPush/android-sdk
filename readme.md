...
Granting notification permissions only controls whether notifications are **displayed in the notification center**. Your app can still receive silent notifications (without user interaction) and **will continue to obtain a valid push token** even if notification permissions are denied.
