...
[![Methods Count](https://img.shields.io/badge/Methods count-core: 1149 | deps: 22321-e91e63.svg)](http://www.methodscount.com/?lib=com.twinpush.android%3Asdk%3A2.1.0)
...
```groovy
dependencies {
    compile 'com.twinpush.android:sdk:2.1.0'
}
```
